...
(function ($) {
    ...
    $.ias = function (options)
    {
        ...
        function get_loader()
        {
            ...
            if (loader.size() === 0) {
                loader = $('<tr class="ias_loader"><td colspan="10" align="center">' + opts.loader + '</td></tr>');
                loader.hide();
            }
            return loader;
        }
        ...
        function get_trigger(callback)
        {
            ...
            if (trigger.size() === 0) {
                trigger = $('<tr class="ias_trigger"><td colspan="10" align="center"><a href="#" class="btn">' + opts.trigger + '</a></td></tr>');
                trigger.hide();
            }
