...
function search(){
	var colName = ["id","avatar","name","name_en","gender",'birthday','education',"born_place","constellation","height","weight","country","program_count","mtime_url","imdb_url"];
...
//feed查看
function program_index(pid){
	var url = ctx+"/sys/program/index_person?person_id="+pid;
	window.open(url);
}
</script>
<style>
	...
	<div class="radius">
		...
		<div class="content">
	    	...
	    	<table  class="search" width="830" border="0" cellspacing="0" cellpadding="0">
	          <tr>
	            <td width="220"><span>标题：</span><input name="obj.name" id="name" type="text" style="width: 160px;"/></td>
	            <td width="180"><span>性别：</span>
	            <select id="gender" name="obj.gender" style="width: 160px;">
	             ...
	             <td width="220"><span>外部URL：</span>
	         	<input name="obj.mtime_url" id="mtime_url" type="text" style="width: 160px;"/>
	            </td>
	        ...
	        <div class="pageCode" id="tabpage">
			 ...
			 <table style="display: none">
		   		...
		   		<tr class="hovcolor">
					...
					<td><a href="javascript:edit('#id#')">中文：#name#  英文：#name_en#</a></td>
					<td>性别：#gender# 出生日期：#birthday# 身高：#height# 体重：#weight# 毕业院校：#education#</td>
					<td>国籍：#country# 家庭地址：#born_place# 星座：#constellation#</td>
					<td>
					#link_url#
					</td>
					<td class="code">
						<a href="javascript:program_index('#id#')">节目(#program_count#)</a>
