...
<form action="${ctx}/sys/imdbPersonMatch/save" method="post" id="inputForm" enctype="multipart/form-data"> 
<div class="pop ">
     <div class="popContent">
      	<table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="16%" align="right">明星文件：</td>
              <td  width="84%" height="50"><input name="upload" id="upload" type="file" />
              	<span style="float:none;" class="red">* <label generated="true" for="upload" class="error">上传文件类型只能上传xls${_msgFor_upload}</label></span>
              </td>
            </tr>
            <tr>
             ...
             <tr>
              ...
              <td  width="84%" height="50" style="color: red">
              	上传文件类型只能上传xls<br />
              	excel中第一行是标题数据，不包含正式数据
              	 请在IMDB匹配结果显导出文件，人工处理完毕，再导入
              </td>
            </tr>
          </table>
	<p class="pBtn"><a class="save" href="javascript:doSave();" title="保  存">提交翻译</a></p>
      </div>
  </div>
</form>
</body>
