...
<form action="${ctx}/sys/weiboFeedMatch/save" method="post" id="inputForm"> 
<div class="pop ">
     <div class="popContent">
      	<table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <td  width="84%" height="50"><input class="w220" id="episode_id" name="episode_id" type="text" value="${episode_id}" />
              	<span style="float:none;" class="red">* <label generated="true" for="episode_id" class="error">剧集id如：54038 ${_msgFor_episode_id}</label></span>
              </td>
            </tr>
            <tr>
