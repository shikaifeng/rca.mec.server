...
/** 新增 **/
function add(){
	var url = "${ctx}/sys/sysconfig/input";
	var t = new $.dialog({title:'添加web系统参数',id:'add', page:url,rang:true,width :600,height:480,
		onXclick:function(){
			t.cancel();
		}
	});
...
/** 编辑 **/
function edit(id){
	var url = "${ctx}/sys/sysconfig/input/"+id;
	var t = new $.dialog({title:'修改web系统参数',id:'edit', page:url,rang:true,width :600,height:480,
		onXclick:function(){
			t.cancel();
		}
	});
...
function del(id){
	confirmDialog(function(){
		var url = "${ctx}/sys/sysconfig/del/"+id+"?t="+new Date().getTime();
...
<div class="container">
	<div class="radius">
		<div class="title">
	    	<div class="location"><span class="current">web系统配置</span></div>
	        <div class="rightBtn"><a href="javascript:add()" title="添加title" target="rightFrame">添加参数</a></div>
	    </div>
		<div class="content">
			<form action="${ctx}/sys/sysconfig/list" id="queryForm" method="post">
