...
function setEditValidate(){
	...
	$("#code").formValidator({onFocus:"请输入名称"}).inputValidator({min:1,onError:"名称不能为空"});
	$("#value").formValidator({onFocus:"请输入值"}).inputValidator({min:1,onError:"值不能为空"});
}
</script>
</head>

<body>
<form action="${ctx}/sysConfig/save" method="post" id="inputForm">
<input type="hidden" name="id" id="id" value="${object.id}" />
<div class="edit_com">
  <ul>
	<li>
	    <div class="r_edit_con">名称：</div>
		<div class="r_edit_inp">
		    <span><input style="width:250px;" type="text" name="code" id="code" maxlength="50" value="${object.code}" /></span>
		</div>
		<div class="r_edit_inp" id="codeTip" style="width:120px" ></div>
	</li>	
	<li>
	    <div class="r_edit_con">值：</div>
		<div class="r_edit_inp">
		    <span><input style="width:250px;" type="text" name="value" id="value" maxlength="50" value="${object.value}" /></span>
		</div>
		<div class="r_edit_inp" id="valueTip" style="width:120px" ></div>
	</li>
	<li>
	    <div class="r_edit_con">备注：</div>
		<div class="r_edit_inp">
		    <span><input style="width:250px;" type="text" name="note" id="note" maxlength="50" value="${object.note}" /></span>
		</div>
	</li>	
  </ul>
