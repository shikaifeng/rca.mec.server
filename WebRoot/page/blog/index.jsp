...
/** 新增 **/
function add(){
	var url = "${ctx}/sys/blog/input";
	var t = new $.dialog({title:'添加blog',id:'add', page:url,rang:true,width :600,height:480,
		onXclick:function(){
			t.cancel();
		}
	});
...
/** 编辑 **/
function edit(id){
	var url = "${ctx}/sys/blog/input/"+id;
	var t = new $.dialog({title:'修改blog',id:'edit', page:url,rang:true,width :600,height:480,
		onXclick:function(){
			t.cancel();
		}
	});
...
function del(id){
	confirmDialog(function(){
		var url = "${ctx}/sys/blog/del/"+id+"?t="+new Date().getTime();
...
<div class="container">
	<div class="radius">
		<div class="title">
	    	<div class="location"><span class="current">blog管理</span></div>
	        <div class="rightBtn"><a href="javascript:add()" title="添加blog" target="rightFrame">添加blog</a></div>
	    </div>
		<div class="content">
			<form action="${ctx}/sys/blog/list" id="queryForm" method="post">
