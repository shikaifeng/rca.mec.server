 ...
 */
public abstract class NoIdModel<M extends NoIdModel> extends Model<M> {
//    private static final TableInfoMapping tableInfoMapping = TableInfoMapping.me();
//    protected Logger log = Logger.getLogger(this.getClass());
    
    protected transient Table table = TableMapping.me().getTable(this.getClass());
    ...
    public JSONObject getJSONObj(){
    	...
    	String[] srr = getAttrNames();
		for(int j=0;j<srr.length;j++){
			obj.put(srr[j],get(srr[j]));
		}
    	return obj;
    }
	...
	public String getUpdated_at_str(){
		Timestamp t = getUpdated_at();
		if(t!=null){
			return DateUtil.getTimeSampleString(new Date(t.getTime()));
		}
		return null;
	}
